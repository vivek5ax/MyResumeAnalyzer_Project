    ...
    return (
        <div className="app-container fade-in">
            <div className="glass-card">
                ...
                <div style={{ marginBottom: '2.5rem', background: 'rgba(255,255,255,0.05)', padding: '1.5rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
                        ...
                        {domainOptions.map(opt => (
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '12px',
                                    border: '1px solid',
                                    borderColor: domain === opt.id ? '#6366f1' : 'rgba(255,255,255,0.1)',
                                    background: domain === opt.id ? 'rgba(99, 102, 241, 0.15)' : 'rgba(255,255,255,0.05)',
                                    color: domain === opt.id ? '#818cf8' : '#94a3b8',
                                    cursor: 'pointer',
                                    transition: 'all 0.3s ease',
                                    fontWeight: domain === opt.id ? '700' : '400',
                                    boxShadow: domain === opt.id ? '0 4px 12px rgba(99, 102, 241, 0.2)' : 'none'
                                }}
                            >
